...
export const MobileApp: React.FC<Props> = ({
  ...
  return (
    <div className={`bg-slate-950 text-slate-100 flex flex-col items-center ${
      compactView ? 'w-full h-full' : isPhoneFrame ? 'min-h-screen py-2 md:py-5' : 'min-h-screen'
    }`}>
      {/* Top Device View Mode Switcher (When not in split view) */}
      {!compactView && (
      ...
      >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-[11px] text-slate-400 font-medium">
              ...
              <button 
                ...
                className="flex items-center gap-1.5 hover:bg-slate-800 transition-colors bg-slate-900 px-2 py-0.5 rounded-lg border border-slate-700/70"
        ...
        <div className="flex-1 overflow-y-auto px-4 pt-3 pb-4">
          ...
          {activeTab === 'contacts' && (
            <MobileContacts onTriggerAICall={() => {
              setAutoTriggerReason(null);
              setIsAICallOpen(true);
            }} />
          )}
        ...
        <nav className="sticky bottom-0 bg-slate-900/95 border-t border-slate-800/80 px-2 py-2 flex items-center justify-around z-30 backdrop-blur-md shadow-lg">
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition-colors ${
              activeTab === 'home' ? 'text-red-400 font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition-colors ${
              activeTab === 'guidance' ? 'text-amber-400 font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition-colors ${
              activeTab === 'contacts' ? 'text-cyan-400 font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition-colors ${
              activeTab === 'alerts' ? 'text-purple-400 font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2.5 rounded-xl transition-colors ${
              activeTab === 'brain' ? 'text-amber-400 font-bold' : 'text-slate-400 hover:text-slate-200'
            }`}
          >
